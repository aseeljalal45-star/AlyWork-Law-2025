...
def calculators_tab():
    ...
    # هنا يمكن إضافة الكود الفعلي لكل حاسبة لاحقًا
...
def rights_tab():
    ...
    - ⚖️ الحق في بدل النقل والسكن إذا نص العقد أو القانون عليه.
    - ⚖️ الحق في الإجازات المرضية والطارئة.
    - ⚖️ الحق في إجازة الحمل والولادة للنساء.
    
    ### التزاماتك:
    - 📌 الالتزام بالحضور والانصياع للقوانين الداخلية للمنشأة.
    - 📌 الالتزام بإشعار صاحب العمل في حالة الغياب أو المرض.
    - 📌 الحفاظ على سرية معلومات العمل.
    - 📌 الالتزام بالشروط التعاقدية وأداء المهام المكلف بها.
    """)


def workers_section():
    section_header("👷 قسم العمال", "👷")
    show_ai_assistant()  # المساعد الذكي
    # تبويبات العمال
    ...
    smart_recommender("العمال")  # اقتراحات ذكية
