...
def show_home_page():
    ...
    <div class="main-header">
        ...
        المنصة الشاملة للتوعية القانونية وحماية الحقوق في الأردن - محدثة وفق تشريعات 2025
        </p>
    </div>
    """, unsafe_allow_html=True)
    ...
    # آخر التحديثات القانونية 2025
    st.markdown("### 📢 آخر التحديثات التشريعية 2025")
    ...
    with col1:
        ...
        <h4>🆕 أبرز تعديلات قانون العمل 2025</h4>
        <ul>
            <li><strong>الحد الأدنى للأجور:</strong> 290 دينار للمؤهلين (زيادة 30 دينار)</li>
            <li><strong>إجازة الأمومة:</strong> 10 أسابيع مدفوعة الأجر بالكامل</li>
            <li><strong>العمل المرن:</strong> تنظيم أوضاع العمل عن بُعد والدوام الجزئي</li>
            <li><strong>الحماية من التحرش:</strong> إجراءات صارمة وعقوبات مشددة</li>
            <li><strong>الضمان الاجتماعي:</strong> تحسينات في نظام المعاشات والتأمينات</li>
        </ul>
        </div>
        """, unsafe_allow_html=True)
    ...
    with col2:
        st.markdown("""
        <div class="info-card">
        <h4>📚 المصادر الرسمية المعتمدة</h4>
        <ul>
            <li>📖 قانون العمل الأردني رقم 8 لسنة 1996 وتعديلاته</li>
            <li>📖 قرار مجلس الوزراء رقم 2025/1 بشأن الحد الأدنى للأجور</li>
            <li>📖 دليل وزارة العمل للإجراءات المحدث 2025</li>
            <li>📖 اللوائح التنفيذية للتأمينات الاجتماعية 2025</li>
        </ul>
        </div>
        """, unsafe_allow_html=True)
