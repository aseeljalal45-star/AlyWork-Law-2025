...
# =====================================================
# =====================================================
# 📚 حقوق العمال والتزاماتهم (مع Expanders)
# =====================================================
def rights_tab():
    ...
    categories = [
        {
            "title": "⚖️ حقوق العمال",
            "items": [
                {"title": "ساعات العمل", "desc": "لا تزيد عن 8 ساعات يومياً أو 48 ساعة أسبوعياً"},
                {"title": "العمل الإضافي", "desc": "أجر ساعة العمل الإضافي لا يقل عن 125٪ من الأجر الأساسي"},
                {"title": "العمل في أيام العطل الرسمية", "desc": "أجر لا يقل عن 150٪ من الأجر المعتاد"},
                {"title": "الإجازة السنوية", "desc": "14 يوم عن كل سنة خدمة، و21 يوم بعد 5 سنوات"},
                {"title": "الإجازة المرضية", "desc": "14 يوماً بأجر كامل"},
                {"title": "مكافأة نهاية الخدمة", "desc": "احتساب وفق آخر أجر"},
                {"title": "بيئة العمل", "desc": "حق العامل في بيئة عمل آمنة وصحية"},
                {"title": "الضمان الاجتماعي", "desc": "حق التسجيل في الضمان الاجتماعي"},
                {"title": "الحماية من الفصل التعسفي", "desc": "حق عدم الفصل التعسفي أو استحقاق تعويض مناسب"}
            ]
        },
        {
            "title": "👩‍🍼 حقوق المرأة العاملة",
            "items": [
                {"title": "إجازة الحمل والولادة", "desc": "وفق القانون الأردني"},
                {"title": "حق الرضاعة", "desc": "ساعة رضاعة يومية بعد الولادة"},
                {"title": "الحماية أثناء الحمل", "desc": "عدم الفصل أثناء الحمل أو مباشرة بعده"},
                {"title": "بيئة العمل", "desc": "بيئة عمل مناسبة وآمنة للمرأة العاملة"}
            ]
        },
        {
            "title": "📋 التزامات العامل",
            "items": [
                {"title": "الالتزام بساعات العمل", "desc": "تنفيذ ساعات العمل المحددة في العقد"},
                {"title": "تنفيذ المهام بدقة وأمانة", "desc": "إتمام المهام الموكلة حسب تعليمات العمل"},
                {"title": "المحافظة على أسرار المنشأة", "desc": "عدم إفشاء المعلومات السرية"},
                {"title": "إشعار صاحب العمل عند الغياب", "desc": "إشعار مسبق عند الغياب أو التأخر"},
                {"title": "عدم مخالفة العقد", "desc": "عدم العمل في مخالفات عقد العمل أو دون موافقة"}
            ]
        },
        {
            "title": "🏢 التزامات صاحب العمل",
            "items": [
                {"title": "دفع الأجور في موعدها", "desc": "تسليم الأجور بالوقت المحدد"},
                {"title": "توفير بيئة عمل آمنة", "desc": "حماية العاملين من المخاطر"},
                {"title": "منح الإجازات القانونية", "desc": "تمكين العامل من الإجازات حسب القانون"},
                {"title": "تسجيل العامل في الضمان الاجتماعي", "desc": "إتمام التسجيل إذا لزم الأمر"},
                {"title": "عدم تجاوز أحكام قانون العمل", "desc": "احترام حقوق العامل وعدم التنازل عنها"}
            ]
        }
    ]
