...
# =====================================================
# قسم العمال مع الخيار الثالث "اعرف حقوقك"
# =====================================================
def show_workers_section():
    ...
    # تنفيذ المنطق حسب الخيار
    if selected_option == "الخيار الأول":
        st.write("تم اختيار الخيار الأول")
    elif selected_option == "الخيار الثاني":
        st.write("تم اختيار الخيار الثاني")
    elif selected_option == "اعرف حقوقك":
        st.success("⚖️ هذه صفحة تعرض حقوق العمال كاملة وفق قانون العمل الأردني.")
        st.markdown("""
        - الحد الأدنى للأجور
...
# =====================================================
# تعريف الأقسام الأخرى بشكل مؤقت لتجنب NameError
# =====================================================
def show_calculators_section():
    st.info("🧮 الحاسبات القانونية (قيد التطوير)")

def show_complaint_simulator():
    st.info("📝 محاكي الشكوى (قيد التطوير)")

def show_authorities_section():
    st.info("🏛️ الجهات المختصة (قيد التطوير)")

def show_settings_page():
    st.info("⚙️ الإعدادات (قيد التطوير)")
...
def main():
    with st.sidebar:
        ...
        page_options = {
            ...
            "👷 العمال": show_workers_section,  # قسم العمال مضاف
