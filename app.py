...
def show_workers_section():
    ...
    # الخيارات المتاحة للعمال
    worker_options = ["الخيار الأول", "الخيار الثاني", "اعرف حقوقك"]
    selected_option = st.radio("اختر خيارك:", worker_options)
    
    if selected_option == "الخيار الأول":
        st.info("تم اختيار الخيار الأول")
    elif selected_option == "الخيار الثاني":
        st.info("تم اختيار الخيار الثاني")
    elif selected_option == "اعرف حقوقك":
        st.success("⚖️ حقوق العمال وفق قانون العمل الأردني:")
        st.markdown("""
        - الحد الأدنى للأجور
        - ساعات العمل والإجازات
        - المكافآت وبدل العمل الإضافي
        - حقوق نهاية الخدمة
        - الإجازات المرضية والإجازات السنوية
        """)
...
def show_calculators_section():
    ...
    st.info("هنا يمكنك حساب مكافأة نهاية الخدمة، بدل العمل الإضافي والإجازات المرضية.")
    # يمكن إضافة نموذج إدخال وحسابات حقيقية لاحقًا

# =====================================================
# 📝 محاكي الشكوى
# =====================================================
def show_complaint_simulator():
    st.markdown("### 📝 محاكي الشكوى الذكي")
    st.info("قم بإدخال الانتهاك أو المشكلة لتوليد توصية قانونية أو نموذج شكوى.")
...
def show_authorities_section():
    ...
    st.info("دليل شامل للجهات الرسمية مع معلومات الاتصال وأوقات العمل.")
...
def show_settings_page():
    ...
    st.info("يمكنك تعديل إعدادات التطبيق مثل تفعيل AI أو تعديل بيانات الاتصال.")
